<div>
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @can('comment_create')
                <x-csv-import route="{{ route('admin.comments.csv.store') }}" />
            @endcan
                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'blog.title'])
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('comment_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.comments.show', $comment) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('comment_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.comments.edit', $comment) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('comment_delete')
